  ...
  return (
    <div className="self-stretch flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        >
          <span className="font-outfit font-semibold text-sm lg:text-base text-secondary-foreground pb-0.5">Internetbanka</span>
          <BankLogos />
        </button>
        ...
        >
          <span className="font-outfit font-semibold text-sm lg:text-base text-secondary-foreground pb-0.5">Apple Pay vai Google Pay</span>
        ...
        >
          <span className="font-outfit font-semibold text-sm lg:text-base text-secondary-foreground pb-0.5">Apmaksa ar karti</span>
          <div className="flex items-center gap-1">
            <div className="h-6 px-2 bg-background rounded-full flex items-center">
