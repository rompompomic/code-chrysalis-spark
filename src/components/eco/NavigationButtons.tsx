...
export default function NavigationButtons() {
  return (
    <div className="flex items-center gap-5 w-full">
      {/* Back button */}
      <button className="flex-1 h-14 bg-eco-light-gray rounded-[200px] flex items-center justify-between pl-10">
      ...
      {/* Forward button */}
      <button className="flex-1 h-14 bg-secondary rounded-[200px] flex items-center justify-between pl-10">
